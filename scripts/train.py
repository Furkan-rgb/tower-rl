...
def dreamer_loop_settings() -> dict[str, object]:
    """The training-loop settings DreamerV3 fixes, by argument name (solution.md 9.4d)."""
    ...
    for dest, value in fixed.items():
        if given[dest] is not None and given[dest] != value:
            raise SystemExit(
                ...
                f"fixed {value} (docs/solution.md 9.4d)"
            )
...
def parse_arguments(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(docs/solution.md 9.4d), which fix the sequence, batch, replay "
